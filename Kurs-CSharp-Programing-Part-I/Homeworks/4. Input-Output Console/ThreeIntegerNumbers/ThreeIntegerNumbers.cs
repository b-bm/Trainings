...
namespace ThreeIntegerNumbers
{
    class ThreeIntegerNumbers
    {
        static void Main()
        {
            Console.WriteLine("Enter 3 Integer Numbers A,B and C: ");
            ...
            // Ver.2. with Nakov's IO.Cin.Class: -> http://www.nakov.com/tag/nakov-io-cin/

            //Console.Write("Enter 3 Integer Numbers A,B and C in one line with a space between them: ");
            //int firstNumber = Nakov.IO.Cin.NextInt();
            //int secondNumber = Nakov.IO.Cin.NextInt();
            //int thirdNumber = Nakov.IO.Cin.NextInt();
